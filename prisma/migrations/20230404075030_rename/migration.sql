/*
  ...
  - Added the required column `base64data` to the `Image` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_Image" ("id", "itemId", "order", "url") SELECT "id", "itemId", "order", "url" FROM "Image";
DROP TABLE "Image";
